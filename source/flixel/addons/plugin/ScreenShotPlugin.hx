...
class ScreenShotPlugin extends flixel.FlxBasic {
    ...
    private var containerScreenShot:Sprite;
    ...
    override public function new():Void {
        ...
        containerScreenShot = new Sprite();
        FlxG.stage.addChild(containerScreenShot);
        ...
        containerScreenShot.addChild(screenshotSprite);
        ...
        containerScreenShot.addChild(flashSprite);
    ...
    override public function destroy():Void {
        ...
        FlxG.stage.removeChild(containerScreenShot);

        super.destroy();

        if (containerScreenShot == null)
            return;

        @:privateAccess
        for (parent in [containerScreenShot, flashSprite, screenshotSprite])
            for (child in parent.__children)
                parent.removeChild(child);

        containerScreenShot = null;
        flashSprite = null;
        flashBitmap = null;
